        ...
        for epoch in range(args.epochs):
            ...
            for real_A, real_B in tqdm(dataloader):
                ...
                if cur_step % args.display_step == 0:
                    ...
                    print(real_A.shape)
                    writer.add_image('Real AB', convert_tensor_image(torch.cat([real_A, real_B], dim=-1), size=(dim_A, target_shape, target_shape)))
                    writer.add_image('Fake BA', convert_tensor_image(torch.cat([fake_B, fake_A], dim=-1), size=(dim_A, target_shape, target_shape)))
